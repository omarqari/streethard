...
- **db.json state (Session 37, 2026-05-18):** 409 active listings (337 sale, 72 rental). **409 at pass2 quality, 0 pass1, 0 partial.** Cron running cleanly daily. 24 misclassified listings manually patched across Sessions 36–37 (see normalize() misclassification note below).
