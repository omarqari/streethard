...
- **Default sort**: Per tab — Inbox: Monthly Payment desc, Shortlist: OQ# asc, Archive: bucket_changed_at desc. **Sticky as of Session 48** — these are first-visit-only fallbacks now; once a bucket has been manually sorted, that choice persists (see Sort control bullet below).
