...
- **db.json state (Session 39, 2026-05-21):** 423 active listings (341 sale, 76 rental, 1 delisted). **422 at pass2 quality, 1 pass1, 0 partial.** The 1 remaining pass1 is likely a duplicate entry for 243 East 77th Street #PHA (IDs 1826929 and 1829073 — same address, both 4 beds, $3.75M). Cron running cleanly daily. 24 misclassified listings manually patched across Sessions 36–37 (see normalize() misclassification note below).
